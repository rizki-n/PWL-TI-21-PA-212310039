    ...
    return (
        <div className='card'>
            ...
            <div className='card-body p-0'>
                <div className='chat-message px-2 bg-light-primary' style={StylesMessager.chatBox}> {/*contoh penggunaan CSS inline*/}
                ...
                <div className='chat-send bg-light p-3'>
                    <form method='post' autoComplete='off' onSubmit={(e) => HandlerSendChat(e)}>
                        <div className='d-flex justify-content-between align-items-center'>
                            <input type='text' className='form-control me-2' autoFocus={true} value={writeChat}
